...
The idea is to create an application in Node.js where the user registers a notes, fills in some information (name, description, note) and creates tags related to it.
